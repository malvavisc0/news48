...
from .workers import build_task_context
...
if not _actors_already_registered():
    ...
    def fact_check_cycle() -> Any:
        ...
        from .fact_checker import run_cycle
    ...
    def feed_fetch_cycle() -> Any:
        ...
        from news48.core.database.feeds import get_all_feeds
    ...
    def download_cycle() -> Any:
        ...
        from news48.cli.commands.download import _download
